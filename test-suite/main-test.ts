...
Deno.test(`connection to the database:`, () => {
  assertNotEquals(
    selectQuery,
    undefined,
    'connect should be returning a query.'
  );
});
Deno.test(`"SELECT" method:`, () => {
  assertNotEquals(
    selectQuery,
    undefined,
    `Error:the method should return a query result.`
  );
});
...
Deno.test(`single-column query in "SELECT" method:`, () => {
  ...
  assertEquals(
    ...
    'SELECT',
    `Error:type is not updated to SELECT`
  );
  assertEquals(
    test.info.action.columns,
    '*',
    `Error:column/columns are updated to *`
  );
  assertEquals(
    test.info.action.table,
    tableName,
    `Error:table is not updated to ${tableName}`
  );
  assertEquals(
    test.info.filter.where,
    true,
    `Error:where is not updated to true`
  );
  assertEquals(
    test.info.filter.condition,
    condition,
    `Error:condition is not updated to ${condition}`
  );
  ...
  assertEquals(
    testQuery,
    `SELECT * FROM userprofile WHERE user_id = 2`,
    'Error:Querybuilder is returning INVALID query string!!'
  );
  assertEquals(
    test.info.action.type,
    null,
    'Error:Type is not reset after query'
  );
  assertEquals(
    test.info.action.columns,
    '*',
    'Error:Columns are not reset after query'
  );
  assertEquals(
    test.info.action.table,
    null,
    'Error:Table is not reset after query'
  );
  assertEquals(
    test.info.filter.where,
    false,
...
Deno.test(`multiple-columns query in "SELECT" method:`, () => {
  ...
  assertEquals(
    test.info.action.columns,
    columnName,
    `Error:column/columns are updated to ${columnName}`
  );
  assertEquals(
    test.info.action.table,
    tableName,
  ...
  assertEquals(
    testQuery,
    `SELECT username, email FROM userprofile WHERE user_id = 1`,
    'Error:Querybuilder is returning INVALID query string!!'
  );
  assertEquals(
    test.info.action.type,
...
Deno.test(`all queries to be valid in "INSERT" method:`, () => {
  ...
  assertNotEquals(
    insertQuery,
    insertSelectQuery1,
    `Expected value: ${insertQuery} not to be equal to Received:${insertSelectQuery1}`
  );
});
...
Deno.test(`single-row query in "INSERT" method:`, () => {
  ...
  assertEquals(
    test.info.action.values,
    `('singleLady')`,
    `Value is not updated to 'singleLady'`
  );
  assertEquals(
    test.info.action.table,
    tableName,
  ...
  assertEquals(
    test.info.action.values,
    '',
    'Error:Value is not reset after query'
  );
});
...
Deno.test(`multiple-rows query in "INSERT" method:`, () => {
  ...
  const tableName = 'userprofile';
  const test = dorm.insert(columnNames).table(tableName);
  assertEquals(
    test.info.action.type,
    'INSERT',
    'Type is not updated to INSERT'
  );
  assertEquals(
    test.info.action.columns,
    'username, password, email, created_on',
    `Columns are not updated to username`
  );
  assertEquals(
    test.info.action.values,
    `('Golden_Retreiver', 'golDenR', 'iamagooddog@dogs.com', 'NOW()'), ('Superman', 'IamnotHuman', 'superman@superman.com', 'NOW()'), ('MrBing', 'BingbingBing', 'chandlerbing@bings.com', 'NOW()')`,
    `Value is not updated to ('Golden_Retreiver', 'golDenR', 'iamagooddog@dogs.com', 'NOW()'), ('Superman', 'IamnotHuman', 'superman@superman.com', 'NOW()'), ('MrBing', 'BingbingBing', 'chandlerbing@bings.com', 'NOW()')`
  );
  assertEquals(
    test.info.action.table,
    tableName,
...
Deno.test(`a single-row query in "UPDATE" method:`, () => {
  const test = dorm
    .update({ username: 'newDogs', password: 'iLoveDogs' })
  ...
  assertEquals(
    updateQuery,
    testUpdateQuery1,
    'Error: the method should work more than one row'
  );
  assertEquals(
    test.info.action.type,
    'UPDATE',
    'Error:Type is not updated to UPDATE'
  );
  assertEquals(
    test.info.action.columns,
    `username = 'newDogs', password = 'iLoveDogs'`,
    `Error:Columns are not updated to username = 'newDogs', password = 'iLoveDogs'`
  );

  assertEquals(
    test.info.action.table,
    'userprofile',
    'Error:Table is not updated to userprofile'
  );
  assertEquals(
    test.info.returning.active,
    true,
    'Error:Returning is not updated'
  );
  assertEquals(
...
Deno.test(`multiple-rows query in "UPDATE" method:`, () => {
  ...
  assertNotEquals(
    multipleRowsQuery,
    testUpdateQuery2,
    `Error:${updateId} rows was not updated `
  );
  assertEquals(
    test.info.action.type,
    'UPDATE',
  ...
  assertEquals(
    test.info.action.columns,
    `username = 'Dogs', password = 'ihave8Dogs'`,
    `column is not updated to username = 'Dogs', password = 'ihave8Dogs'`
  );
  assertEquals(
    test.info.action.table,
    'userprofile',
...
Deno.test(`all rows query in "UPDATE" method:`, () => {
  ...
  assertNotEquals(
    allRowsUpdateQuery,
    testUpdateQuery3,
    'Error:The whole table was not updated'
  );
  assertEquals(
    test.info.action.type,
    'UPDATE',
  ...
  assertEquals(
    test.info.action.columns,
    `username = 'restarted', password = 'iamADog'`,
    `column is not updated to username = 'restarted', password = 'iamADog'`
  );
  assertEquals(
    test.info.action.table,
    'userprofile',
...
Deno.test(`all queries to be valid in "DELETE" method:`, () => {
  ...
  const test = dorm.delete().from(tableName).where(condition).returning();
  assertEquals(
    test.info.action.type,
    'DELETE',
    'Error:Type should be updated to DELETE'
  );
  assertEquals(
    test.info.action.table,
    tableName,
  ...
  assertEquals(
    test.info.filter.where,
    true,
    `Error:where should be updated to true`
  );
  assertEquals(
    test.info.filter.condition,
    condition,
    `Error:condition should be updated to ${condition}`
  );
  assertEquals(
    test.info.returning.active,
    true,
    'Error:Returning should be updated'
  );
  assertEquals(
    test.info.returning.columns,
    '*',
    'Error:Columns in Returning should be pdated'
  );
...
Deno.test(`single-row query in "DELETE" method:`, () => {
  ...
  assertEquals(
    ...
    true,
    'Error:Delete query is not completed!'
  );
  assertEquals(
    test.info.action.type,
    'DELETE',
    'Error:Type is not updated to DELETE'
  );
  assertEquals(
    test.info.action.table,
    tableName,
...
Deno.test(`multiple-rows query in "DELETE" method:`, () => {
  ...
  assertNotEquals(
    testDeleteQuery2,
    deleteMultipleQuery,
    'Error:Multiple DELETE query is not completed!'
  );
  assertEquals(
    test.info.action.type,
    'DELETE',
...
Deno.test(`all rows cannot be deleted in "DELETE" method:`, () => {
  ...
  assertEquals(
    deleteAllQuery,
    'No delete without where (use deleteAll to delete all rows)',
    'Error:Multiple DELETE query is not completed!'
  );
  assertEquals(
    test.info.action.type,
